...
from ..model.cache_utils import Cache, DynamicCache, StaticCache
...
class LlamaMLP(nn.Module):
    ...
    def forward(self, x):
        ...
        return down_proj, intermediate_states.detach()
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states_split = query_states.view(bsz, q_len, self.num_heads, self.head_dim)
        key_states_split = key_states.view(bsz, q_len, self.num_key_value_heads, self.head_dim)
        value_states_split = value_states.view(bsz, q_len, self.num_key_value_heads, self.head_dim)

        query_states = query_states_split.transpose(1, 2)
        key_states = key_states_split.transpose(1, 2)
        value_states = value_states_split.transpose(1, 2)
        ...
        attn_output_save = attn_output.detach()
        ...
        return attn_output, attn_weights, past_key_value, attn_output_save
...
class LlamaSdpaAttention(LlamaAttention):
    ...
    def forward(
        ...
        return attn_output, None, past_key_value, attn_output_save
