...
from utils.model.model_utils import create_hf_trained_model, create_hf_model
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="my_data/mmlu", required=True)
    parser.add_argument("--dataset", type=str, default="boolq", required=True)
    parser.add_argument("--output_dir", type=str, default="eval/gsm", required=True)
    parser.add_argument(
        "--model_name_or_path",
        type=str,
        help=
